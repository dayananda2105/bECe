...
public class MainActivity3 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(MainActivity3.this,"nandu", Toast.LENGTH_LONG).show();
    ...
    public boolean onNavigationItemSelected (@NonNull MenuItem item){
        ...
        switch (item.getItemId()) {
            case R.id.Profile:
                Intent dps1 = new Intent(MainActivity3.this,subatt2.class);
                bottomnav.setVisibility(View.VISIBLE);
                startActivity(dps1);
                break;
            case R.id.My_Orders:
                Intent dps = new Intent(MainActivity3.this,previouspup.class);
                bottomnav.setVisibility(View.VISIBLE);
                startActivity(dps);
                break;
            case R.id.My_Profile:
                Intent dp = new Intent(MainActivity3.this,sirsub.class);
                bottomnav.setVisibility(View.VISIBLE);
                startActivity(dp);
                break;
            case R.id.edit_profile:
                bottomnav.setVisibility(View.INVISIBLE);
                Intent i = new Intent(MainActivity3.this, internalu.class);
                startActivity(i);
                break;
            case R.id.Change_pass:
                bottomnav.setVisibility(View.INVISIBLE);
                Intent d2 = new Intent(MainActivity3.this, studentdet.class);
                startActivity(d2);
                break;
            case R.id.Logout:
                bottomnav.setVisibility(View.INVISIBLE);
                DBclass db=new DBclass(MainActivity3.this);
                db.open();
                String des1=name.getText().toString();
                db.deleteEntry(des1);
                Toast.makeText(this,des1+"Logout", Toast.LENGTH_SHORT).show();
                Intent d4 =new Intent(MainActivity3.this,MainActivity.class);
                startActivity(d4);
                finish();
                break;
        }
